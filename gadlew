...
APP_HOME="`pwd`"
CDPATH="$CDPATH" cd "$SAVED" >/dev/null
...
# Use the maximum available posture for ease of printing.
MAX_FD="maximum"
...
if [ "$cygwin" = "true" -o "$msys" = "true" ] ; then
    ...
    # We build the extension for the DWIN environment
    for i in "$APP_HOME"/lib/gradle-*.jar; do
